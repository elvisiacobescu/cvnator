...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 09 2016 г., 11:26
...
--
-- Дамп данных таблицы `userdate`
--

INSERT INTO `userdate` (`Id`, `Mail`, `Parola`) VALUES
(100, 'vital@mail.ru', '1234'),
(101, 'elvis@mail.ru', '1234'),
(102, 'daniel@mail.ru', '1234');
...
CREATE TABLE `tab1` (
  `Sdut1` int(123) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Структура таблицы `tab2`
--

CREATE TABLE `tab2` (
  `Sdut2` varchar(123) DEFAULT NULL,
  `an` int(123) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Дамп данных таблицы `tab2`
--

INSERT INTO `tab2` (`Sdut2`, `an`) VALUES
('Ce este functia ?', 0),
('Care este ?', 0),
('Ex1', 1);
--
...
('root', '[{"db":"cv","table":"userdate"},{"db":"CV","table":"UserDate"},{"db":"ex1","table":"tab2"},{"db":"ex1","table":"tab1"},{"db":"EX1","table":"TAB1"}]');
...
('root', '2016-04-09 09:13:54', '{"collation_connection":"utf8mb4_unicode_ci","lang":"ru"}');
