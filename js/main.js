...
//are un /n care face ceva vudu o.O
  function asckname(){
   ...
   function test (){
     document.getElementById('nume-utilizator-helo').innerHTML +=  mail;
   }
   //var auto_refresh = setInterval(function() { test(); }, 10000);
   asckprice();
   asckname();//location.reload();
